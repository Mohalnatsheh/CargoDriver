...
//region App name
const mAppName = 'CarGo Driver';
//endregion

//region DomainUrl
const DOMAIN_URL =
    'https://cargoapp.tech'; // Don't add slash at the end of the url
//endregion

//region Google map key
const GOOGLE_MAP_API_KEY = 'AIzaSyChJPyYsKFI44Sud90jQ1LvEzh8JLyBdUU';
//endregion

//region Currency & country code
const currencySymbol = '\$';
const currencyNameConst = 'jod';
...
const mOneSignalAppIdDriver = '4b553587-d454-4bf8-b4df-db4a20ec1646';
const mOneSignalRestKeyDriver =
    'os_v2_app_jnktlb6ukrf7rng73nfcb3awi222s2vkodzemieqktq7cd2vgyzg7w6tmtrmpbphkqninkcz46q62zm6pvtjy4ycz7irzhixlobgwxy';
const mOneSignalDriverChannelID = '7c1344c7-2a85-4756-9e2e-c5e358b44c31';

const mOneSignalAppIdRider = 'YOUR_ONE_SIGNAL_APPID_RIDER';
const mOneSignalRestKeyRider = 'YOUR_ONE_SIGNAL_RESTKEY_RIDER';
const mOneSignalRiderChannelID = 'YOUR_ONE_SIGNAL_CHANNELID_RIDER';
//endregion

//region firebase configuration
// FIREBASE VALUES FOR ANDROID APP
const apiKeyFirebase = 'AIzaSyCVGCvgk_fFp0CbJL4Jzo9kefvWqvsuV7s';
const appIdAndroid = '1:70634174037:android:990fe211c693215a3fc6dc';
const projectId = 'cargoapplicat';
const storageBucket = 'cargoapplicat.firebasestorage.app';
const messagingSenderId = '70634174037';
const authDomain = "cargoapplicat.firebaseapp.com";
const measurementId = "G-Z0ZD06RXMK";
// FIREBASE VALUES FOR IOS APP
const appIdIOS = '1:70634174037:ios:eafcc653989bc44d3fc6dc';
const IOS_BUNDLE_ID = 'com.cargoapp.driver';
const AndroidClientID =
    '70634174037-fkaufhn1olioile493bnth3g4k0f84mr.apps.googleusercontent.com';
const IOSClientID =
    "70634174037-m42p5rdkt1751tbff7sul2v7175d0of7.apps.googleusercontent.com";
//endregion
